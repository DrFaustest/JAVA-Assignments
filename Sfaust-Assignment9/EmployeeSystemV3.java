...
// Employee system runner. Use this to test your assignment 8.
// Created by Lucas Hartman - MCC - INFO 1521
// Version 3 - Modified to work with the new employee types


import java.util.Scanner;
import java.util.ArrayList;

public class EmployeeSystemV3 {
    ...
    public static void calculateWeeklyPay(ArrayList<Employee> emp)
    {
        ...
        for (Employee e : emp)
        {
            ...
            System.out.println(e.getFirstName() + " " + e.getLastName() + "\nWeekly Pay: " + Employee.currency.format(pay));
            total += pay;
        } 
        // print out total
